...
def get_minibatches_linear(X_full, y_full, batch_size, **kwargs):
    """Function to get minibatches from the full batch"""
...
#     initial_y[0,0] = 0
    ...
    for i in range(feature_number):
        ...
        y_real_plus = analytic_functions.real_y(X_delta_plus[:, 0])
        y_real_minus = analytic_functions.real_y(X_delta_minus[:, 0])
